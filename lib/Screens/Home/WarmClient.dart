...
import 'FiltterPage1.dart';
import 'HomePage.dart';
import 'SetReminder1.dart';
import 'UpdateClientDetails.dart';

class WarmClient extends StatefulWidget {
  const WarmClient({super.key});

  @override
  State<WarmClient> createState() => _WarmClientState();
}

class _WarmClientState extends State<WarmClient> {
  @override
    ...
    if (list.isEmpty) {
      return Scaffold(
          appBar: AppBar(
            ...
            title: Text("Warm Client",style:TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.w500),
            ),
            leading:InkWell(
                onTap: (){
                    ...
                    Expanded(
                      ...
                      child: InkWell(
                        onTap: (){
                          ...
                          Get.to(FittersPages(),transition: Transition.fadeIn, duration: Duration(milliseconds: 100));
                        },
                        child: Padding(
                          padding: const EdgeInsets.symmetric(horizontal:10,vertical: 0),
                          child: Container(
