...
class FiltterPage3 extends StatefulWidget {
  const FiltterPage3({super.key});

  @override
  State<FiltterPage3> createState() => _FiltterPage3State();
}

class _FiltterPage3State extends State<FiltterPage3> {
  @override
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            Get.to(DeadClient(),transition: Transition.fadeIn, duration: Duration(milliseconds: 100));
