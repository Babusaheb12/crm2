...
import 'FiltterPage3.dart';
import 'HomePage.dart';
import 'SetReminder3.dart';
import 'UpdateClientDetails.dart';

class DeadClient extends StatefulWidget {
  const DeadClient({super.key});

  @override
  State<DeadClient> createState() => _DeadClientState();
}

class _DeadClientState extends State<DeadClient> {
  @override
    ...
    if (list.isEmpty) {
      return Scaffold(
          appBar: AppBar(
            ...
            title: Text("Dead Client",style:TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.w500),
            ),
            leading:InkWell(
                onTap: (){
                    ...
                    Expanded(
                      ...
                      child: InkWell(
                        onTap: (){
                          ...
                          Get.to(FiltterPage3(),transition: Transition.fadeIn, duration: Duration(milliseconds: 100));
                        },
                        child: Padding(
                          padding: const EdgeInsets.symmetric(horizontal:10,vertical: 0),
                          child: Container(
