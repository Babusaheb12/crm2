...
class HomePageHr extends StatefulWidget {
  const HomePageHr({super.key});

  @override
  State<HomePageHr> createState() => _HomePageHrState();
}

class _HomePageHrState extends State<HomePageHr> with WidgetsBindingObserver {
  @override
