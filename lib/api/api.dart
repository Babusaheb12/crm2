...
class ApiUrls {
  ...
  // static String BASE_URL = "https://crm.technoderivation.com/test-api/App/";
  static String BASE_URL2 = "https://nodecrm.technoderivation.com:3002/";  //// this is a chat base url
...
/// End point url
  ...
  static const String MultipleCall= "agent/client/add_calling_multiple_history";
  ...
  static const String AllNotificationCounter= "agent/user/getNotificationCount";
  static const String MarkNotification= "agent/user/notificationMarkAllRead";
  /// this is a chat dashboard
  static final String ChatAlluser= "${BASE_URL2}user/allusers";  /// this is correct base url
  static final String ChatHistory= "${BASE_URL2}messages/getAllMessages";  /// this is correct base url
  static final String chatImageUpload= "agent/upload/image_upload";    /// this is ia chat image upload
  static final String markRead = "${BASE_URL2}user/mark-read";    /// this is ia chat image upload
