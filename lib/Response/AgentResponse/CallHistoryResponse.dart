/// status : "200"
/// data : [{"id":"2502","client_name":"Super Construction","client_mobile":"+918854842806","client_email":null,"call_duration_in_second":"107","calling_type":"Outgoing","calling_time":"13:33","calling_date":"2024-09-08","calling_platform":"call"},{"id":"2501","client_name":"Super Construction","client_mobile":"+918854842806","client_email":null,"call_duration_in_second":"0","calling_type":"Missed","calling_time":"09:16","calling_date":"2024-09-09","calling_platform":"call"}]
...
class CallHistoryResponse {
  ...
  CallHistoryResponse.fromJson(dynamic json) {
    _status = json['status'];
    if (json['data'] != null) {
      _data = [];
      json['data'].forEach((v) {
  ...
  String? _status;
  List<Data>? _data;
CallHistoryResponse copyWith({  String? status,
  List<Data>? data,
}) => CallHistoryResponse(  status: status ?? _status,
  data: data ?? _data,
);
...
/// client_email : null
/// call_duration_in_second : "107"
/// calling_type : "Outgoing"
/// calling_time : "13:33"
/// calling_date : "2024-09-08"
