...
class HomePageDevloperManager extends StatefulWidget {
  const HomePageDevloperManager({super.key});

  @override
  State<HomePageDevloperManager> createState() => _HomePageDevloperManagerState();
}

class _HomePageDevloperManagerState extends State<HomePageDevloperManager> with WidgetsBindingObserver {
  @override
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      /*InkWell(
                            ...
                            child: Text("ToDo List  ",style: TextStyle(color:Color(0xff233f6e),fontSize: 18,fontWeight: FontWeight.w500),)),
                        SizedBox(height: 15,),
                        InkWell(
                            onTap: (){
                              setState(() {
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Text(
                                      ...
                                      // : (authController.Dashboardresponse!.data!.totalUsers?.toString() ?? "0"))
                                      // : "0",
                                      "0",  /// ise khuch time ke liye show karaya h
                                      style: TextStyle(
                                        color: Colors.black,
                                        fontSize: 18,
                                        fontWeight: FontWeight.w500,
